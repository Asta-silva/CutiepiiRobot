...
if ENV:
    ...
    try:
        DEMONS = {int(x) for x in os.environ.get("SUPPORT_USERS", "").split()}
    except ValueError:
    ...
    EVENT_LOGS = os.environ.get("EVENT_LOGS", "-1001643635068") # G-Ban Logs (Channel) (-100)
    ...
    DB_URL = os.environ.get("DATABASE_URL", "postgresql://cossaojk:apEf76LRIlm0RL_SUngGreMghS7Bm5fb@castor.db.elephantsql.com/cossaojk") # Any SQL Database Link (RECOMMENDED:- PostgreSQL & https://www.elephantsql.com)
